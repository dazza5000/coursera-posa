...
{	
    ...
    public void print(final String outputString)
    {
         ...
         */
        // TODO - You fill in here.
    	final String text = mTextViewOutput.getText().toString();
        final String textToDisplay = text + outputString + "\n";
    	((Activity) mActivity.get()).runOnUiThread(new Runnable() { @Override public void run() { mTextViewOutput.append(textToDisplay);}});
    }
